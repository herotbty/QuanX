...
function get_emoji(emojip, sname) {
  var Lmoji = { 
    "🏳️‍🌈": ["Lưu lượng", "Thời gian", "Khẩn cấp", "Đã hết hạn", "Băng thông", "hết hạn"],
    "🇦🇿": ["Azerbaijan"],
    "🇦🇹": ["Áo", "Áo", "Austria", "Áo"],
    "🇦🇺": ["AU", "Australia", "Sydney", "Úc", "Úc", "Melbourne", "Sydney", "Turbo Úc", "Bắc Kinh Úc", "Quảng Châu Úc", "Thượng Hải Úc", " Thượng Hải và Macao "," Quảng Châu và Macao "],
    "🇧🇪": ["BE", "比利時","比利时"],
    "🇧🇬": ["保加利亚", "保加利亞","Bulgaria"],
    "🇵🇰": ["巴基斯坦"],
    "🇰🇭": ["柬埔寨"],
    ...
    "🇸🇦": ["沙特", "迪拜"],
    "🇸🇪": ["SE", "Sweden","瑞典"],
    "🇸🇬": ["SG", "Singapore", "SINGAPORE", "Singapore", "Lion City", "Huxin", "Jingxin", "Quanxin", "Suixin", "Shenxin", "Hangxin", "Guangxin" , "Guangxin", "Huxin"],
    ...
    "🇻🇳": ["VN", "Việt Nam", "Thành phố Hồ Chí Minh"],
